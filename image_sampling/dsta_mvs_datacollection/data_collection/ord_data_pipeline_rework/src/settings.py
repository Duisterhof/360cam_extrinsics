...
def get_args():
    ...
    parser.add_argument('--ros-path-suffix', default='',
                        help='suffix of the output folder ')

    parser.add_argument('--sample-cycle-mode', type=int, default=0,
                        help='0 random, 1 min, 2 max (default: 0)')

    parser.add_argument('--cycle-min-nodes', type=int, default=50,
                        help='minimum path length (default: 0)')

    parser.add_argument('--interactive', action='store_true', default=False,
                        help='save selected path to another foler, defined with --ros-path-dir')

    parser.add_argument('--ros-path-dir', default='',
                        help='folder name of selected loopy path')


    # Graph sampling - step 3 sample position
    parser.add_argument('--position-path-suffix', default='',
                        help='suffix of the position folder ')
    ...
    parser.add_argument('--requests-path', default='',
                        help='path to the requests.json file. See README for formatting details. | ** V2 **')

    parser.add_argument('--metadata-path', default='',
                        help='path to the metadata.json file. See README for formatting details. | ** V2 **')
    
    parser.add_argument('--frame-graph-path', type=str, 
                        help='The path to the frame graph JSON file. Sea README for formatting details. | ** V2 **')

    parser.add_argument('--collection-out-dir-override', type=str, default='',
                        help='Set this to override the "outdir" setting in the reqeusts.json file.')

    parser.add_argument('--position-folder', default='',
                        help='folder for position files (default: )')

    parser.add_argument('--data-folder-suffix', default='',
    ...
    parser.add_argument('--rig-type', default='Scene_DepthPlanner',
                        help='ground truth rig type Scene, DepthPlanner (default: Scene_DepthPlanner)')

    parser.add_argument('--rand-degree', type=int, default=180,
    ...
    parser.add_argument('--min-pitch', type=int, default=-90,
                        help='yaw threshold (default: -45)')

    parser.add_argument('--max-roll', type=int, default=90,
                        help='yaw threshold (default: 90)')

    parser.add_argument('--min-roll', type=int, default=-90,
                        help='yaw threshold (default: -90)')
    ...
    parser.add_argument('--load-posefile-multiview', action='store_true', default=False,
                        help='load multiview config and collect multiview data')

    parser.add_argument('--load-posefile-parallelmultiview', action='store_true', default=False,
                        help='load multiview config and collect multiview data in a parallelized manner')

    parser.add_argument('--start', type=int, default=0,
                        help='start index for parallelized data collection')

    parser.add_argument('--stop', type=int, default=100,
                        help='stop index for parallelized data collection')
                        
    parser.add_argument('--nbatch', type=int, default=0,
                        help='batch size for parallelized data collection')
                        
    parser.add_argument('--idxid', type=int, default=0,
                        help='container id for parallelized data collection')
    ...
    parser.add_argument('--save-as-six-imgs', action='store_true', default=False,
                        help='save as six planar images pointed in different directions rather than panorama')
    ...
    parser.add_argument('--add-extrinsic-noise', action='store_true', default=False, 
                        help='Enable adding noise to the camera extrinsics for multiview.')    

    parser.add_argument('--frame-stepsize', type=int, default=1,
                        help='step size for traversing over trajectory, i.e. a value of 5 means every 5th trajectory pnt')          

    parser.add_argument('--disable-meta-random-orientation', action='store_true', default=False, 
                        help='WARNING: Deprecated! Set this flag to disable random orientation for data sampler based on the metadata reader. ')
